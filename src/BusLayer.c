...
BusLayer *bus_layer_create(GRect frame)
{
    ...
    if (!bus_layer->route_text_layer || !bus_layer->destination_text_layer ||
        !bus_layer->due_text_layer || !bus_layer->footer_text_layer) {
      if (bus_layer->route_text_layer) text_layer_destroy(bus_layer->route_text_layer);
      if (bus_layer->destination_text_layer) text_layer_destroy(bus_layer->destination_text_layer);
      if (bus_layer->due_text_layer) text_layer_destroy(bus_layer->due_text_layer);
      if (bus_layer->footer_text_layer) text_layer_destroy(bus_layer->footer_text_layer);
